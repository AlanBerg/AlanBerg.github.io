...
Website: [https://sites.google.com/view/la-genai/](https://sites.google.com/view/la-genai/)

1. [Handout](WORKSHOPS/LAK25/Session Schedule and Handout.pdf')
2. [Reading List](WORKSHOPS/LAK25/READINGLIST_BestPractices_LAK25.pdf)
3. [Support material](WORKSHOPS/LAK25/Demo_LAK25_GenAI_Dashboard.html) in the form of an HTML dashboard. \
***NOTE*** there is a QR code pointing to a google form to add best practices or relevant reading material.
4. [Best and Worst practices LA magazine](https://npuls.nl/en/knowledge-base/learning-analytics-magazine-best-and-worst-practices/)
5. [Student support magazine ](https://npuls.nl/en/knowledge-base/learning-analytics-magazine-ii/)
